...
define('FULC_DEFAULT_OVERVIEW_CONTENT', $str = '<h2 class="bn-inline-content">Welcome to your wiki</h2><p class="bn-inline-content">This is <strong>your </strong><a target="_blank" rel="noopener noreferrer nofollow" href="https://en.wikipedia.org/wiki/Wiki">wiki</a>, where you can do whatever you want.</p><p class="bn-inline-content">You can use it to:</p><ul><li><p class="bn-inline-content">Develop ideas</p></li><li><p class="bn-inline-content">Use it as a notebook</p></li><li><p class="bn-inline-content">Collect links, files and data</p></li><li><p class="bn-inline-content">Post code snippets you find useful</p></li></ul><p class="bn-inline-content">These are just <strong>suggestions</strong>. Do whatever <strong>you want</strong>. It is <strong>your</strong> wiki.</p><h2 class="bn-inline-content">Some tips to get you started</h2><ul><li><p class="bn-inline-content"><strong>Edit this page.</strong> Click on the <strong>edit icon</strong> or press <strong>e</strong> on your keyboard, the editor will open. You can insert files from your Google Drive by using the Drive-button in the menu bar.</p></li><li><p class="bn-inline-content"><strong>Insert a new page.</strong> Click on the <strong>New Page</strong> button on the top left to create a <strong>new page below the current page</strong>. If you want to <strong>create a page somewhere else</strong> in your wiki, <strong>hover over an entry</strong> in the page tree and <strong>click</strong> the <strong>+</strong>-button.</p></li><li><p class="bn-inline-content"><strong>Search your wiki.</strong> Click into the <strong>search box</strong> or press <strong>^K</strong> on your keyboard to search your wiki. The search box will also show your last visited wiki pages.</p></li></ul><h2 class="bn-inline-content">Markdown shortcuts</h2><p class="bn-inline-content">If you know markdown you can use it as a shortcut to structure your content. You simply type the markdown marker and hit space. Fulcrum supports the following markers:</p><h1 class="bn-inline-content"># Header 1</h1><h2 class="bn-inline-content">## Header 2</h2><h3 class="bn-inline-content">### Header 3</h3><p class="bn-inline-content">#### Header 4</p><p class="bn-inline-content">##### Header 5</p><p class="bn-inline-content">###### Header 6</p><ul><li><p class="bn-inline-content">* bullet point</p></li></ul><p class="bn-inline-content">> quote+-9*<br>+</p><p class="bn-inline-content"></p>');
